          ...
          <div className="space-y-8 lg:order-2">
            <div className="space-y-6">
              ...
              <div className="prose prose-lg text-gray-600 space-y-4 text-right">
                <p>
                  ד״ר נעמי קוביליאנסקי היא רופאת משפחה מוסמכת עם התמחות יחודית בדיקור רפואי. 
                  עם למעלה מ-12 שנות ניסיון ברפואת משפחה, היא החלה ללמוד דיקור רפואי כדי לספק 
                  למטופליה טיפול הוליסטי ומקיף יותר.
                </p>
                
                <p>
                  ד״ר קוביליאנסקי מאמינה בכוחו של שילוב בין הרפואה המערבית המודרנית לבין חכמת 
                  הרפואה המזרחית העתיקה. היא מתמחה בטיפול בכאבים כרוניים, חרדות, בעיות שינה, 
                  בעיות פוריות ומגוון רחב של מצבים רפואיים.
                </p>
                
                <p>
                  בזמנה הפנוי, ד״ר קוביליאנסכי נהנית לעסוק ביוגה ומדיטציה, ומשתתפת בקורסי השתלמות 
